...
function SelectCategories({ setCategoryId }: CategoriesProps) {
  const ENDPOINT_CATEGORIES =
    'https://get-hired-forum-dev.herokuapp.com/api/categories';
  ...
  useEffect(() => {
    callApi(ENDPOINT_CATEGORIES).then((response) => {
