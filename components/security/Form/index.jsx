    ...
    return(
        ...
        <form className={classes.formulario}>
            <div className={classes.encabezadoModal}>
                <label className={classes.Encabezado}>Elige un motivo para denunciar esta publicación</label>
                {children}
            </div>
            ...
            <div className={classes.ButtonContainer}>
                ...
                {!!sendInfo && (
                    ...
                    <button disabled={false} className={classes.sendButtonActive} type='submit' onClick={() => onSend()}>
                        Enviar
                    </button>
                ...
                {!sendInfo && (
                    ...
                    <button disabled={true} className={classes.sendButtonInactive} type='submit' onClick={() => onSend()}>
                            Enviar
                    </button>
